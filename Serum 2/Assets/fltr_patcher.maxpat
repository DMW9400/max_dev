...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 825.0, 510.000005304813385, 74.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 825.0, 465.333337306976318, 74.0, 22.0 ],
					"saved_object_attributes" : 					{
						"_persistence" : 1,
						"normalized" : 0,
						"smoothing" : 1.0
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 825.0, 420.00000262260437, 74.0, 22.0 ],
					"saved_object_attributes" : 					{
						"_persistence" : 1,
						"normalized" : 0,
						"smoothing" : 1.0
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 825.0, 377.333334684371948, 74.0, 22.0 ],
					"saved_object_attributes" : 					{
						"_persistence" : 1,
						"normalized" : 0,
						"smoothing" : 1.0
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 825.0, 332.0, 74.0, 22.0 ],
					"saved_object_attributes" : 					{
						"_persistence" : 1,
						"normalized" : 0,
						"smoothing" : 1.0
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 720.0, 510.0, 74.0, 22.0 ],
					"saved_object_attributes" : 					{
						"_persistence" : 1,
						"normalized" : 0,
						"smoothing" : 1.0
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 720.0, 465.333334684371948, 74.0, 22.0 ],
					"saved_object_attributes" : 					{
						"_persistence" : 1,
						"normalized" : 0,
						"smoothing" : 1.0
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 626.000000476837158, 510.0, 74.0, 22.0 ],
					"saved_object_attributes" : 					{
						"_persistence" : 1,
						"normalized" : 0,
						"smoothing" : 1.0
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 626.000000476837158, 465.0, 74.0, 22.0 ],
					"saved_object_attributes" : 					{
						"_persistence" : 1,
						"normalized" : 0,
						"smoothing" : 1.0
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 589.166675478219986, 4.0, 38.666649043560028, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 513.0, 136.0, 27.0, 28.0 ],
					"saved_attribute_attributes" : 					{
						"focusbordercolor" : 						{
							"expression" : ""
						}
,
						"valueof" : 						{
							"parameter_initial" : [ 0.5 ],
							"parameter_initial_enable" : 1,
							"parameter_longname" : "f3_lvl",
							"parameter_mmax" : 1.0,
							"parameter_modmax" : 1.0,
							"parameter_modmode" : 4,
							"parameter_shortname" : "f3_lvl",
							"parameter_type" : 0,
							"parameter_unitstyle" : 1
						}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 8,
					"outlettype" : [ "", "", "", "", "", "", "", "" ],
					"patching_rect" : [ 58.66666841506958, 206.666672825813293, 196.33333158493042, 22.0 ],
					"text" : "route 84 85 86 87 88 89 90"
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 1,
					"midpoints" : [ 575.785714285714334, 357.0, 597.0, 357.0, 597.0, 318.0, 348.0, 318.0, 348.0, 192.0, 68.16666841506958, 192.0 ],
					"source" : [ "obj-8", 16 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-5", 0 ],
					"hidden" : 1,
					"midpoints" : [ 349.5, 270.0, 594.5, 270.0 ],
					"order" : 0,
					"source" : [ "obj-86", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 1,
					"midpoints" : [ 68.16666841506958, 279.0, 570.0, 279.0, 570.0, 318.0, 690.500000476837158, 318.0 ],
					"source" : [ "obj-88", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 1,
					"midpoints" : [ 93.500001498631065, 270.0, 711.0, 270.0, 711.0, 372.0, 690.500000476837158, 372.0 ],
					"source" : [ "obj-88", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 1,
					"midpoints" : [ 118.833334582192549, 270.0, 711.0, 270.0, 711.0, 417.0, 690.500000476837158, 417.0 ],
					"source" : [ "obj-88", 2 ]
				}
		...
		"parameters" : 		{
			"obj-100" : [ "f3_pan", "f3_pan", 0 ],
			"obj-102" : [ "f3_mix", "f3_mix", 0 ],
			"obj-104" : [ "f3_var", "f3_var", 0 ],
			"obj-106" : [ "f3_drive", "f3_drive", 0 ],
			"obj-108" : [ "f3_res", "f3_res", 0 ],
			"obj-110" : [ "f3_freq", "f3_freq", 0 ],
			"obj-112" : [ "live.menu[1]", "live.menu[2]", 0 ],
			"obj-34" : [ "f1_res[4]", "f1_res", 0 ],
			"obj-36" : [ "f1_res[5]", "f1_res", 0 ],
			"obj-38" : [ "f1_res[6]", "f1_res", 0 ],
			"obj-40" : [ "f1_res[1]", "f1_res", 0 ],
			"obj-43" : [ "f1_res[2]", "f1_res", 0 ],
			"obj-45" : [ "f1_res[3]", "f1_res", 0 ],
			"obj-48" : [ "f2_lvl", "f2_lvl", 0 ],
			"obj-54" : [ "f2_pan", "f2_pan", 0 ],
			"obj-56" : [ "f2_mix", "f2_mix", 0 ],
			"obj-58" : [ "f2_var", "f2_var", 0 ],
			"obj-60" : [ "f2_drive", "f2_drive", 0 ],
			"obj-63" : [ "f2_res", "f2_res", 0 ],
			"obj-65" : [ "f1_freq", "f1_freq", 0 ],
			"obj-66" : [ "live.menu[8]", "live.menu[2]", 0 ],
			"obj-68" : [ "f1_res", "f1_res", 0 ],
			"obj-70" : [ "f1_drive", "f1_drive", 0 ],
			"obj-72" : [ "f1_var", "f1_var", 0 ],
			"obj-74" : [ "f1_pan", "f1_pan", 0 ],
			"obj-76" : [ "f1_mix", "f1_mix", 0 ],
			"obj-78" : [ "f1_lvl", "f1_lvl", 0 ],
			"obj-84" : [ "f2_freq", "f2_freq", 0 ],
			"obj-86" : [ "live.menu[10]", "live.menu[2]", 0 ],
			"obj-90" : [ "f1_res[7]", "f1_res", 0 ],
			"obj-92" : [ "f3_res[1]", "f3_res", 0 ],
			"obj-94" : [ "f1_res[9]", "f1_res", 0 ],
			"obj-98" : [ "f3_lvl", "f3_lvl", 0 ],
			"parameterbanks" : 			{
				"0" : 				{
					"index" : 0,
					"name" : "",
